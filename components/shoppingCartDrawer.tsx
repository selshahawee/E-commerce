...
import { getTotal, removeFromCart, updateCartQty } from 'redux/reducers/app'
import { RootState } from 'redux/store'
import { CartItem, GoogleSheetProduct } from 'types'
...
const dispatch=useDispatch()
  ...
  // useEffect(() => {
  //   dispatch(getTotal(cartTotalAmount))
                  ...
                  <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                                ...
                                <div className="ml-4 flex flex-1 flex-col">
                                  <div>
                                    <div className="flex justify-between text-base font-medium text-gray-900">
                                      ...
                                      <p className="ml-4">{cartItem.cartQty*cartItem.price }</p>
                                    </div>
                    ...
                    <div className="border-t border-gray-200 py-6 px-4 sm:px-6">
                      <div className="flex justify-between text-base font-medium text-gray-900">
                        <p>Subtotal</p>
                        {cart.cartItems?.map((cartItem: any) => (
                          <p key={cartItem.id}>${cartItem.price * cartItem.cartQty}</p>
                          ))}
                      </div>
